...
local w = library:CreateWindow("Arsenal PWNERS (beta)") 

local b = w:CreateFolder("Mods") 

b:Label("https://discord.gg/rQEHvHFGNf",{
    TextSize = 15; 
...
local b = w:CreateFolder("Weapons mod")

b:Button("Rapid fire",function()
